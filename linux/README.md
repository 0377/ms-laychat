...
别忘了vendor/GatewayWorker/Applications/Laychat/Config/Db.php，workerman的数据库同步跟上。
...
gatewayworker，然后移植本程序的业务逻辑部分即可。如果您是linux，请运行 php ./vendor/GatewayWorker/start.php start,然后不要关闭窗口。此外，如果您更改了数据库连接，请更改 vendor/Workerman/Applications/Config/Db.php 的配置   
